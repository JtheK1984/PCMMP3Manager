...
begin
  qry_Work.sql.Text:=  ASSQL_GetLizenzCount_PCMMP3[iDBType];
  qry_Work.open;
...
begin
  ...
  qry_Work.SQL.Text:= ASSQL_GetUserLizenz_PCMMP3[iDbType];
  qry_Work.open;
...
begin
  ...
  slocale:= iniFile.ReadString('PCMMP3Manager','Language','DE');
