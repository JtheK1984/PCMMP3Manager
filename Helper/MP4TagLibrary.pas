//********************************************************************************************************************************
//*                                                                                                                              *
//*     MP4 Tag Library 1.0.46.100 © 3delite 2012-2019                                                                           *
...
Const
    MP4TAGLIBRARY_VERSION = $010046100;
    MP4TAGLIBRARY_VERSION_FRIENDLY = '1.0.46.100 (Ivan Llanas branch)';
...
type
    ...
    public
        ...
        function SetAsText(Value: String): Boolean;
    ...
    public
        ...
        function AddXtra(FieldName: String): TMP4Xtra;
        ...
        function DeleteXtra(FieldName: String): Boolean; overload;
        ...
        function FindAtomXtra(FieldName: String): TMP4Xtra; overload;
        function FindAtomXtraIndex(FieldName: String): Integer;
        ...
        function GetTextXtra(FieldName: String): String;
        function SetTextXtra(FieldName: String; Value: String): Boolean;
        function GetIntegerXtra(FieldName: String; out Value: Int64): Boolean;
        function SetIntegerXtra(FieldName: String; Value: Int64): Boolean;
        function GetGUIDXtra(FieldName: String; out Value: TGUID): Boolean;
        function SetGUIDXtra(FieldName: String; Value: TGUID): Boolean;
        function GetFileTimeXtra(FieldName: String; out Value: TDateTime): Boolean;
        function SetFileTimeXtra(FieldName: String; Value: TDateTime): Boolean;
    ...
    function IsSameAtomName(ID: TAtomName; Name: String): Boolean; overload; inline;
    function IsSameAtomName(ID1: TAtomName; ID2: TAtomName): Boolean; overload; inline;

    function StringToAtomName(Name: String; var ID: TAtomName): Boolean; inline;
...
function TMP4Tag.AddXtra(FieldName: String): TMP4Xtra;
var
    MP4Xtra: TMP4Xtra;
begin
...
function TMP4Tag.DeleteXtra(FieldName: String): Boolean;
var
    Index: Integer;
begin
    Result := False;
...
function TMP4Tag.FindAtomXtra(FieldName: String): TMP4Xtra;
var
    i: Integer;
begin
    Result := nil;
...
function TMP4Tag.FindAtomXtraIndex(FieldName: String): Integer;
var
    i: Integer;
begin
    Result := - 1;
...
function TMP4Tag.GetTextXtra(FieldName: String): String;
var
    Xtra: TMP4Xtra;
begin
    Result := '';
...
function TMP4Tag.GetFileTimeXtra(FieldName: String; out Value: TDateTime): Boolean;
var
    Xtra: TMP4Xtra;
begin
    Result := False;
...
function TMP4Tag.SetFileTimeXtra(FieldName: String; Value: TDateTime): Boolean;
var
    Xtra: TMP4Xtra;
    Index: Integer;
begin
...
function TMP4Tag.GetIntegerXtra(FieldName: String; out Value: Int64): Boolean;
var
    Xtra: TMP4Xtra;
begin
    Result := False;
...
function TMP4Tag.SetTextXtra(FieldName, Value: String): Boolean;
var
    Xtra: TMP4Xtra;
    Index: Integer;
begin
...
function TMP4Tag.SetIntegerXtra(FieldName: String; Value: Int64): Boolean;
var
    Xtra: TMP4Xtra;
begin
    Result := False;
...
function TMP4Tag.GetGUIDXtra(FieldName: String; out Value: TGUID): Boolean;
var
    Xtra: TMP4Xtra;
begin
    Result := False;
...
function TMP4Tag.SetGUIDXtra(FieldName: String; Value: TGUID): Boolean;
var
    Xtra: TMP4Xtra;
begin
    Result := False;
...
function TMP4Xtra.SetAsText(Value: String): Boolean;
var
    DataBytes: TBytes;
begin
    Data.Clear;
