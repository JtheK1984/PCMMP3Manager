...
msbuild E:/Projekte/Windows/PCMMP3Manager/PCMMP3Manager.dproj /t:Clean;Build;CompressWin32 /p:config=Release /p:platform=Win32
...
call "E:\Inno\Setupfiles\Programme\PCMLizenzgenerator\PCMLizenzgenerator.exe" /PCM-MP3Manager /1.6 /E:\Inno\Setupfiles\Programme\PCMMP3Manager_x64
